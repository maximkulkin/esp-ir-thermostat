...
static ac_fan_string(ac_fan fan) {
...
static ac_swing_string(ac_swing swing) {
...
static print_state(const char *prompt, fujitsu_ac_state_t *state) {
    printf(
        "%s: command=%d mode=%d fan=%d swing=%d temperature=%d\n",
        prompt,
